...
export default function HomePage() {
  ...
  return <main>
    ...
    <section className="hero wrap">
      <img className="hero-image" src={staticAsset("/home/hero.webp")} alt="Zwei glückliche Männer in einer liebevollen Begegnung" width="1170" height="659" />
    ...
    <section className="wrap feature feature-dark"><div><p className="kicker">Fotoflirt</p><h2>Manchmal beginnt ein Flirt mit einem Blick.</h2><p>Wenn die richtigen Worte noch fehlen, hilft der Fotoflirt beim unkomplizierten ersten Kennenlernen.</p><a className="text-link light" href={`${SITE_URL}/fotoflirt.html`}>Fotoflirt ausprobieren →</a></div><img src={staticAsset("/home/fotoflirt.webp")} alt="Fotoflirt mit Profilbildern von Männern" width="449" height="275" /></section>
